    ...
    public class SeedData
    {
        public static void SeedDatabase(DataContext context)
        {
            ...
            if (!context.Products.Any())
            {
                ...
                Category technique = new Category { Name = "Technique", Slug = "technique" };
                Category tools = new Category { Name = "Tools", Slug = "tools" };
                Category alcohol = new Category { Name = "Alcohol", Slug = "alcohol" };
